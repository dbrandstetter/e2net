...
(function ($) {
    ...
    var $window = $(window), $body = $('body'), settings = {
        ...
        // Carousels
        carousels: {
            speed: 4, fadeIn: true, fadeDelay: 250
        },
    ...
    // Dropdowns.
    $('#nav > ul').dropotron({
        mode: 'fade', speed: 350, noOpenerFade: true, alignment: 'center'
    });
    ...
    $('.carousel').each(function () {
        ...
        var $t = $(this), $forward = $('<span class="forward"></span>'),
            $backward = $('<span class="backward"></span>'), $reel = $t.children('.reel'),
        ...
        if (settings.carousels.fadeIn) {
            ...
            $t.scrollex({
                mode: 'middle', top: '-20vh', bottom: '-20vh', enter: function () {
